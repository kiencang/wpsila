...
# --- CẤU HÌNH ---
# Phien ban PHP ban dang dung
PHP_VERSION="8.3"          

# 128mb cho VPS 1GB. 256mb rat de gay crash MySQL/Redis
REDIS_MAX_MEMORY="128mb"   

# Vị trí chứa file cấu hình
REDIS_CONF="/etc/redis/redis.conf"

# Chạy lệnh
# curl -sL https://raw.githubusercontent.com/kiencang/wpsila/refs/heads/main/install_redis_demo.sh | bash
